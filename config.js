...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || "+18456521821"  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
module.exports = {
  ...
  packname:  process.env.PACK_NAME || 'MADE BY NOMI MALIK',
